...
<template>
    <button
        @click="toggleDark"
        class="relative flex h-9 w-9 items-center justify-center rounded-full transition-colors hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none"
        :aria-label="isDark ? 'Activar modo claro' : 'Activar modo oscuro'"
    >
        <!-- Sol (visible en modo claro) -->
        <svg
            class="absolute h-5 w-5 text-yellow-500 transition-all duration-300"
        ...
        <svg
            class="absolute h-5 w-5 text-blue-400 transition-all duration-300"
