    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Gestionar Pedidos</h2>
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="mb-6 grid gap-4 sm:grid-cols-6">
                    ...
                    <div class="rounded-lg bg-emerald-100 p-4 shadow">
                        <p class="text-sm text-emerald-800">💰 Ingresos</p>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <tr v-for="pedido in pedidos.data" :key="pedido.id" class="hover:bg-gray-50">
                                <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">#{{ pedido.id }}</td>
                                <td class="whitespace-nowrap px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">{{ pedido.user.name }}</div>
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{{ pedido.items.length }}</td>
                                <td class="whitespace-nowrap px-6 py-4 text-sm font-bold text-gray-900">{{ Number(pedido.total).toFixed(2) }}€</td>
                    ...
                    <div class="border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700">
                                Mostrando <span class="font-medium">{{ pedidos.from }}</span> a <span class="font-medium">{{ pedidos.to }}</span> de <span class="font-medium">{{ pedidos.total }}</span> resultados
                            </div>
