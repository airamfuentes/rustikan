...
watch(estadoFiltro, (val) => {
    tiendaPagina.value = 1;
    router.get(route('admin.solicitudes.index'), { estado: val }, { preserveState: true });
});
watch(filtros, () => { tiendaPagina.value = 1; }, { deep: true });
watch(() => props.estado, (v) => { estadoFiltro.value = v; });
        ...
        <div class="py-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div v-if="tiendas.length > 0"
                    ...
                    <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-5">
                        ...
                        <select v-model="estadoFiltro"
                            ...
                            <option value="pendiente">Pendientes ({{ counts.pendiente ?? 0 }})</option>
                            <option value="aprobado">Aprobadas ({{ counts.aprobado ?? 0 }})</option>
                            <option value="rechazado">Rechazadas ({{ counts.rechazado ?? 0 }})</option>
                        </select>
                ...
                <div v-if="tiendas.length === 0"
                    ...
                    <p class="text-lg font-medium">No hay solicitudes {{ estadoFiltro === 'pendiente' ? 'pendientes' : estadoFiltro === 'aprobado' ? 'aprobadas' : 'rechazadas' }}</p>
                </div>
                ...
                <div v-for="tienda in tiendasPaginadas" :key="tienda.id"
                    ...
                    <div class="flex items-center justify-between px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <div v-if="estadoFiltro === 'pendiente'" class="flex items-center gap-2">
                    ...
                    <div class="divide-y divide-gray-50 dark:divide-gray-700">
                        <div v-for="s in tienda.solicitudes" :key="s.id"
                            ...
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <div v-if="estadoFiltro === 'pendiente'" class="flex shrink-0 flex-col gap-2 sm:flex-row sm:items-start">
