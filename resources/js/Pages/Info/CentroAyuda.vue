    ...
    <div :class="isDark ? 'dark' : ''">
        ...
        <section class="bg-gradient-to-br from-teal-600 via-cyan-700 to-sky-800 pt-24 pb-20 text-white">
            <div class="mx-auto max-w-4xl px-4 text-center">
                ...
                <h1 class="text-4xl font-bold tracking-tight sm:text-5xl">Centro de ayuda</h1>
                <p class="mt-4 text-lg text-teal-100 max-w-2xl mx-auto">Encuentra respuestas rápidas o contacta con nuestro equipo.</p>
