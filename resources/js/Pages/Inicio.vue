...
<template>
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <section id="categorias" class="py-16" v-reveal>
                ...
                <div class="flex flex-wrap justify-center gap-8">
                    ...
                    >
                        ...
                        <div class="relative flex h-24 w-24 items-center justify-center rounded-full border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm transition-all duration-300 group-hover:scale-105 group-hover:border-primary-400 group-hover:shadow-xl">
                            <CategoriaIcono :slug="cat.slug" :icono="cat.icono" class="h-9 w-9 text-gray-700 dark:text-gray-200 group-hover:text-primary-500 transition-colors pb-2" />
        ...
        <section id="mapa" class="relative pt-16 pb-28 bg-white dark:bg-gray-800" v-reveal>
